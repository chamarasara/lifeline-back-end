...
router.get('/single-raw-material/:_id', RawMaterialController.raw_materials_get_one);
//Update raw material
router.patch('/update-raw-material/:_id', RawMaterialController.update_raw_material);
//Delete raw material
