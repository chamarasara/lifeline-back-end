...
//New purchase order
router.post('/new-purchase-order-raw', upload.single('supplierInvoice'), PurchaseOrdersRawController.purchase_order_raw_add_new);
//All purchase orders
...
router.patch('/update-purchase-order-raw/:id', upload.single('supplierInvoice'), PurchaseOrdersRawController.update_purchase_order_raw);
