const RawMaterial = require('../../models/master/RawMaterialMaster');
const mongoose = require('mongoose');

//Add new rwa material 
exports.raw_material_add_new = (req, res, next) => {
...
//Delete raw material
exports.delete_raw_material = (req, res, next) => {
    const id = req.params._id;
    RawMaterial.remove({ _id: id })
        .exec()
        .then(result => {
