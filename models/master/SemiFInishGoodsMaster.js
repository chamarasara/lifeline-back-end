...
const SemiFinishGoodMasterSchema = new mongoose.Schema({
...
module.exports = SemiFinishGoodsMaster = mongoose.model('SemiFinishGoodsMaster', SemiFinishGoodMasterSchema)